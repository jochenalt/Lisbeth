...
set("quadruped-reactive-walking_INCLUDE_DIRS" "/home/jochen/lisbeth/controller/install/include")
set("QUADRUPED_REACTIVE_WALKING_INCLUDE_DIRS" "/home/jochen/lisbeth/controller/install/include")
set("quadruped-reactive-walking_DOXYGENDOCDIR" "${PACKAGE_PREFIX_DIR}/share/doc/quadruped-reactive-walking/doxygen-html")
set("QUADRUPED_REACTIVE_WALKING_DOXYGENDOCDIR" "${PACKAGE_PREFIX_DIR}/share/doc/quadruped-reactive-walking/doxygen-html")
set("quadruped-reactive-walking_DEPENDENCIES" "Eigen3;eigenpy;pinocchio;eiquadprog;yaml-cpp")
set("quadruped-reactive-walking_PKG_CONFIG_DEPENDENCIES" "")
...
set("quadruped-reactive-walking_LIBRARIES" ${_PACKAGE_CONFIG_LIBRARIES})
set("QUADRUPED_REACTIVE_WALKING_LIBRARIES" ${_PACKAGE_CONFIG_LIBRARIES})
...
IF(COMMAND ADD_REQUIRED_DEPENDENCY)
  FOREACH(pkgcfg_dep ${quadruped-reactive-walking_PKG_CONFIG_DEPENDENCIES})
    ADD_REQUIRED_DEPENDENCY(${pkgcfg_dep})
  ENDFOREACH()
ENDIF(COMMAND ADD_REQUIRED_DEPENDENCY)

include("${CMAKE_CURRENT_LIST_DIR}/quadruped-reactive-walkingTargets.cmake")
check_required_components("quadruped-reactive-walking")
